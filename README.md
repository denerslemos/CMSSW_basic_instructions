...
Note that older versions of CMSSW uses old Linux systems (e.g. pPb 2016 data uses CMSSW_8_0_X with is CentOs6 based). To use those systems, you have to use a container. To do it you have to type the version of Linux you want in the terminal BEFORE ```cmsrel``` command. 
